...
* via weekly HDX exports [here](https://data.humdata.org/dataset/drc-uganda-ebola-outbreak-osm-may-2026), which have been downloaded over 245 times 
* and via other OpenStreetMap export tools such as [GeoFabrik](https://download.geofabrik.de/) or [Overpass Turbo](https://overpass-turbo.eu/). 
...
<figure>
<img src="/assets/uploads/20260707-ebola-mapping_be-mapathon_alex-jaillon_pro-ciupzk91.webp">
<p class="caption">Fig 3 A Missing Maps Mapathon organized by MSF Belgium on 16 June 2026./Alexandre Jaillon, MSF
</p>
</figure>
...
Looking forward, volunteers can support by continuing to update individual buildings. For example, in the towns of Bunia and Mongwalu, and elsewhere in the Ituri Province, as published on an ongoing basis on the [HOT Tasking Manager](https://tasks.hotosm.org/explore?campaign=DRC+Ebola+2026&omitMapResults=1). In addition, expanding the road network and expanding information on the state of the roads can serve the logistics and facilitate access for medical teams. It can also help anticipate evaluation in areas MSF and other organizations have not visited yet.
